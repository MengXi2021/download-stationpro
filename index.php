...
<div class="mdui-container" style="max-width: 400px; ">
        ...
        <div class="mdui-card" style="border-radius: 16px;">
            ...
            <div class="mdui-card-primary">
                <div class="mdui-card-primary-title"><?php echo get_info('about_title'); ?></div>
                <div class="mdui-card-primary-subtitle"><?php echo get_info('about_say'); ?></div>
            </div>
            <div class="mdui-card-content"><?php echo get_info('about_see'); ?></div>
