...
<body class="mdui-appbar-with-toolbar  mdui-theme-primary-<?php echo get_info('color'); ?> mdui-theme-accent-<?php echo get_info('accent_color'); ?> mdui-theme-layout-auto">
    <header class="mdui-appbar mdui-appbar-fixed">
        <div class="mdui-toolbar mdui-color-theme">
            ...
            <!-- 尊重版权，请不要删除！ -->
            <a href="https://mengxiblog.top" target="_blank" class="mdui-btn mdui-btn-icon mdui-ripple mdui-ripple-white" mdui-tooltip="{content: '查看作者网页'}"><i class="mdui-icon material-icons">code</i></a>
        </div>
    </header>